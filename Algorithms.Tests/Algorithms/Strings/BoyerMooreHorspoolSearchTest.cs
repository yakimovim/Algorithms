...
namespace EdlinSoftware.Tests.Algorithms.Strings
{
    ...
    public class BoyerMooreHorspoolSearchTest
    {
        ...
        private StringSearchMatch[] Search(string toSearchIn, string pattern, IEqualityComparer<char> comparer = null) => BoyerMooreHorspoolSearch.Search(toSearchIn, pattern, comparer).ToArray();
    }
}